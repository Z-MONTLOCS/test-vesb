...
from .config_utils_auto import initialize_driver,seleccionar_tipo_documento_y_identificacion,download_captcha_image,solve_captcha_and_click_button,click_send,close_driver,switch_to_new_tab,get_data_table,get_affiliation_table,close_browser,extract_names
